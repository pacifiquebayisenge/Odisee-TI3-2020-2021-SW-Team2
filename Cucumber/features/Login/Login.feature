...
Functionaliteit:  Inloggen
    ...
    En : bevindt zich op  de loginpagina van de applicatie

    Scenario: succesvolle login
   
    Als : de gebruiker het juiste email adress invoert
    En : en het juiste wachtwoord invoert
    ...
    Als : de gebruiker een ongeldig email adress invoert
    En : en het juiste wachtwoord invoert
    En : op de login knop drukt    
    Dan : zou de gebruiker niet ingelogd moeten zijn    
    En : zou er een foutmelding moeten worden weergegeven 